...
- Condense & Generalize Research Experience
  + Examined how the relationship between the alliance and subsequent symptom change in depression treatment varies as a function of informant  --> _Applied HLM, factor analysis, and mediation in order to critically assess predictors of outcome and methods focused questions in depression treatment_
  + Serve as a reviewer for several empirical journals --> _Critically evaluate research and provide written reviews and recommendation_
  
- Cut your publications section down to a bullet point --> _Publish empirical findings in multiple peer-reviewed journal outlets and speak at international conferences_
